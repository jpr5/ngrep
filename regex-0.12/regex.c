...
/* 
   ...
   2001-2-25: This file has been modified to replace int re_max_failures
     with a #define.  This avoids compile problems when other various libc's
     already have that symbol.  It has also been modified to be 64-bit
     clean.  --jordan

   2025-11-17: This file has been modified to fix compiler warnings and
     stylistic deprecations due to more modern C23-compatible standards.
...
/* Forward declaration for function using compile_stack_type */
...
/* Forward declarations for functions using register_info_type */
	...
	/* \<digit> has been turned into a `duplicate' command which is
        ...
        case duplicate:
	  {
		...
		/* Compare that many; failure if mismatch, else move
                   past them.  */
		if (translate 
                    ? bcmp_translate ((const unsigned char *)d, (const unsigned char *)d2, mcnt, translate)
                    : bcmp (d, d2, mcnt))
		  goto fail;
		d += mcnt, d2 += mcnt;
	      }
